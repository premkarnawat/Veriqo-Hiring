  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'linear-gradient(135deg, #020617 0%, #0F172A 40%, #1E293B 100%)',
        'glow-primary': 'radial-gradient(ellipse at center, rgba(37, 99, 235, 0.15) 0%, transparent 70%)',
        'glow-trust': 'radial-gradient(ellipse at center, rgba(16, 185, 129, 0.1) 0%, transparent 70%)',
      },
      animation: {
      ...
      boxShadow: {
        ...
        'glow-trust': '0 0 30px rgba(16, 185, 129, 0.2)',
